...
interface OnboardingInitializedModalProps {
  isOpen: boolean
  onClose: () => void
  characterName?: string
}

export function OnboardingInitializedModal({ isOpen, onClose, characterName }: OnboardingInitializedModalProps) {
      ...
      <div className="bg-white rounded-lg shadow-lg max-w-2xl w-full mx-4">
        ...
        <div className="p-6">
          <p className="text-gray-700 mb-6">
            Base introduction screens have been created for <span className="font-semibold">{characterName}</span>.
          </p>
