            ...
            scenarios.map((scenario) => ({
              ...
              relyingParty: scenario.relyingParty
                ? {
                    ...
                    tenantId: scenario.relyingParty.tenantId,
              ...
              issuer: scenario.issuer
                ? {
                    ...
                    tenantId: scenario.issuer.tenantId,
      ...
      scenarios: result.scenarios.map((scenario: any) => ({
        ...
        ...(scenario.scenario.relyingParty && {
          relyingParty: {
            ...
            tenantId: scenario.scenario.relyingParty.tenantId,
        ...
        ...(scenario.scenario.issuer && {
          issuer: {
            ...
            tenantId: scenario.scenario.issuer.tenantId,
        ...
        scenarios: (scenariosMap.get(showcase.id) || []).map((s: any) => {
          ...
          if (s.scenario.relyingParty) {
            scenarioData.relyingParty = {
              ...
              tenantId: s.scenario.relyingParty.tenantId,
          ...
          if (s.scenario.issuer) {
            scenarioData.issuer = {
              ...
              tenantId: s.scenario.issuer.tenantId,
