...
export const credentialSchema = z.object({
  credentialId: z.string().min(1, "Credential ID is required"), // Allow credentialId to be optional
  schemaId: z.string().min(1, "Schema ID is required"), // schemaId is required
