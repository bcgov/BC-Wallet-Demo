...
exports.lawyerCustom = void 0;
const dateint_1 = require("../src/utils/dateint");
const now = () => Math.floor(new Date().getTime() / 1000);
exports.lawyerCustom = {
    name: 'Joyce',
    type: 'Lawyer',
    ...
    revocationInfo: [
        {
            ...
            description: 'Revoking your credentials does not mean that is it unusable. Services may accept revoked credentials especially for information that is unchanging, such as your birthday.',
        },
        {
            credentialName: 'member_card',
            credentialIcon: '/public/lawyer2/icon-lawyer2.svg',
            title: 'Revoke your LSBC Member Card',
            description: 'The Law Society of BC allows you to revoke your own Member Card if:\n• there is a problem with your credential.\n• your device was lost or stolen and you want to secure your personal information.',
        },
    ],
    progressBar: [
        {
    ...
    onboarding: [
        ...
        },
        {
            ...
            credentials: [
                {
                    name: 'member_card',
                    version: (_a = process.env.LAWYER_VERSION) !== null && _a !== void 0 ? _a : '1.0',
        ...
        },
        {
            ...
            credentials: [
                {
                    name: 'Person',
                    version: (_b = process.env.PERSON_VERSION) !== null && _b !== void 0 ? _b : '1.0',
                    ...
                    attributes: [
                        ...
                        },
                        {
                            ...
                            value: `${(0, dateint_1.getDateInt)(5)}`,
                        },
                        {
                            name: 'birthdate_dateint',
                            value: `${(0, dateint_1.getDateInt)(-19)}`,
                        },
                    ],
                },
            ],
