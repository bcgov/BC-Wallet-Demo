...
exports.businessCustom = void 0;
const dateint_1 = require("../src/utils/dateint");
exports.businessCustom = {
    name: 'Dave',
    type: 'Proprietor',
            ...
            credentials: [
                {
                    ...
                    version: (_a = process.env.BUSINESS_VERSION) !== null && _a !== void 0 ? _a : '1.0.0',
                    ...
                    attributes: [
                        ...
                        },
                        {
                            ...
                            value: `${(0, dateint_1.getDateInt)(-1)}`,
                        },
                        {
                            name: 'role',
                            value: 'PROPRIETOR',
