...
exports.studentCustom = void 0;
const dateint_1 = require("../src/utils/dateint");
exports.studentCustom = {
    name: 'Alice',
    type: 'Student',
    ...
    onboarding: [
        ...
        },
        {
            ...
            credentials: [
                {
                    name: 'student_card',
                    version: (_a = process.env.STUDENT_VERSION) !== null && _a !== void 0 ? _a : '1.0',
                    ...
                    attributes: [
                        ...
                        {
                            name: 'expiry_date',
                            value: `${(0, dateint_1.getDateInt)(4)}`,
                        },
                    ],
                },
            ],
