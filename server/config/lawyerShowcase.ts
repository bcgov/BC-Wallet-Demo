...
export const lawyerShowcase: Showcase = {
  ...
  credentials: [
    ...
    },
    {
      ...
      attributes: [
        ...
        { name: 'expiry_date_dateint', value: `${getDateInt(5)}` },
        { name: 'birthdate_dateint', value: `${getDateInt(-19)}` },
      ],
    },
    {
      name: 'Person',
  ...
  revocationInfo: [
    {
      ...
      name: 'Revoke your Person Credential',
      description:
    ...
    },
    {
      ...
      credentialIcon: '/public/lawyer2/icon-lawyer2.svg',
      name: 'Revoke your LSBC Member Card',
      description:
  ...
  introduction: [
    ...
    },
    {
      ...
      name: 'Accessing court materials',
    ...
    },
    {
      ...
      name: 'Get your lawyer credential',
  ...
  scenarios: [
    {
      ...
      screens: [
        {
          screenId: 'START',
          name: 'Gain access to court materials online',
        ...
        {
          screenId: 'CONNECTION',
          name: 'Start proving you’re a lawyer',
    ...
    },
    {
      ...
      screens: [
        {
          screenId: 'START',
          name: 'Gain access to the Court Library in person',
        ...
        },
        {
          ...
          requestOptions: {
            name: 'Court Library (DEMO) Request',
    ...
    },
    {
      ...
      screens: [
        {
          screenId: 'START',
          name: 'Verify a BC Wallet application',
          text: 'Verify that you are using a valid BC Wallet application.',
          image: '/public/lawyer2/useCases/courtServices/bothCreds.svg',
        },
        {
          screenId: 'CONNECTION',
          name: 'Connect to Attestation Service',
