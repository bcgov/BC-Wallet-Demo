...
| api_server.env.CORS_ALLOW_CREDENTIALS                              | string | `"true"` |  |
| api_server.env.CORS_ALLOW_HEADERS                                  | string | `"Content-Type, Authorization"` |  |
| api_server.env.CORS_ALLOW_METHODS                                  | string | `"GET, POST, PUT, DELETE, OPTIONS"` |  |
| api_server.env.CORS_ALLOW_ORIGINS                                  | string | `"*"` |  |
| api_server.env.APP_NAME                                            | string | `"bc-wallet-api"` |  |
| api_server.env.CORS_DISABLED                                       | bool | `true` |  |
| api_server.env.SHOWCASE_DB_HOST                                    | string | `"bc-wallet-postgresql"` |  |
| api_server.env.SHOWCASE_DB_NAME                                    | string | `"showcase-db"` |  |
| api_server.env.SHOWCASE_DB_PORT                                    | string | `"5432"` |  |
| api_server.env.SHOWCASE_DB_USERNAME                                | string | `"showcase-user"` |  |
...
| demo_server.env.SHOWCASE_DB_HOST                                   | string | `"bc-wallet-postgresql"` |  |
| demo_server.env.SHOWCASE_DB_NAME                                   | string | `"showcase-db"` |  |
| demo_server.env.SHOWCASE_DB_PORT                                   | string | `"5432"` |  |
| demo_server.env.SHOWCASE_DB_USERNAME                               | string | `"showcase-user"` |  |
...
| showcase_creator.env.SHOWCASE_DB_HOST                              | string | `"bc-wallet-postgresql"` |  |
| showcase_creator.env.SHOWCASE_DB_NAME                              | string | `"showcase-db"` |  |
| showcase_creator.env.SHOWCASE_DB_PORT                              | string | `"5432"` |  |
| showcase_creator.env.SHOWCASE_DB_USERNAME                          | string | `"showcase-user"` |  |
...
| traction_adapter.env.AMQ_HOST                                      | string | `"rabbitmq"` |  |
| traction_adapter.env.AMQ_PORT                                      | int | `5672` |  |
| traction_adapter.env.AMQ_USERNAME                                  | string | `"guest"` |  |
| traction_adapter.env.AMQ_PASSWORD                                  | string | `"guest"` |  |
