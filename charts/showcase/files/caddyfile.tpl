:{{ .Values.showcase.frontend.containerPort }} {
    ...
    @encode_static {
        not path {{ .Values.showcase.baseRoute }}/demo/* {{ .Values.showcase.baseRoute }}/server/* {{ .Values.showcase.baseRoute }}/agent/* {{ .Values.showcase.baseRoute }}/public/* {{ .Values.showcase.baseRoute }}/uploads/* {{ .Values.showcase.baseRoute }}/qr {{ .Values.showcase.baseRoute }}/i/*
    }
    ...
    handle {{ .Values.showcase.baseRoute }}* {
        ...
        @spa_router {
            ...
            not path {{ .Values.showcase.baseRoute }}/demo/* {{ .Values.showcase.baseRoute }}/server/* {{ .Values.showcase.baseRoute }}/agent/ready {{ .Values.showcase.baseRoute }}/public/* {{ .Values.showcase.baseRoute }}/uploads/* {{ .Values.showcase.baseRoute }}/qr {{ .Values.showcase.baseRoute }}/i/*
            file {
        ...
        @pass {
            path {{ .Values.showcase.baseRoute }}/demo/* {{ .Values.showcase.baseRoute }}/server/* {{ .Values.showcase.baseRoute }}/agent/ready {{ .Values.showcase.baseRoute }}/public/* {{ .Values.showcase.baseRoute }}/uploads/* {{ .Values.showcase.baseRoute }}/qr {{ .Values.showcase.baseRoute }}/i/*
        }
